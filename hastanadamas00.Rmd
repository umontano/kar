...
mixed3 <- lmer(Tiempo ~ 1 + MD + Imagen +  MD : Imagen  + (1 | Nombre) + (1 | Edad) + (1 | Sexo) , data=hast, model=FALSE, x=FALSE, y=FALSE)
mixed2 <- lmer(Tiempo ~ 1 + MD + Imagen +  MD : Imagen  + (1 | Nombre) + (1 | Edad) , data=hast, model=FALSE, x=FALSE, y=FALSE)
mixed1 <- lmer(Tiempo ~ 1 + MD + Imagen +  MD:Imagen  + (1 | Nombre) , data=hast, model=FALSE, x=FALSE, y=FALSE)
